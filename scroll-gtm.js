...
/**
  ...
  * Version - 5, last update Nov 21, 2022
*/
(function(){
	var CP_ScrollTracking = (function () {
       ...
       /* advanced settings - change with caution */
        SETTINGS.debug=true; // set to "false" in production environments.
       ...
       function backFill(bucket){
		...
		return{  // public interface
				init: function(){
                  ...
                  var _timeout=1; // trigger immediatly
                  ...
                  if(Math.round((window.innerHeight/document.documentElement.scrollHeight)*100)<=SETTINGS.percentage_threshold){
                    ...
                    if(event_name=="gtm.historyChange"){
                      _timeout=1500; // add slight delay to wait for it to fully render
                    ...
                    debug_util("failed passed threshold evaluation",SETTINGS.percentage_threshold);
                  }
